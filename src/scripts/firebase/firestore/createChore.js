...
//         document.body.append(modal)
        ...
        //         if (title) {
        //             resolve('added new chore to database')
        //         } else {
        //             reject('failed to add new chore to database')
        //         }
        //         console.log('addToDB end')
        //     })
